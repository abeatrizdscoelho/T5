...
export default function EditarServico() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const EditarServico = { id: Number(id), nome, descricao, preco: Number(preco) };
        try {
            const res = await fetch(`http://localhost:3000/api/servicos/${id}`, {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(EditarServico)
            });
            if (res.ok) {
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row mt-4 mb-3">
                        <div className="col-md-6">
                            ...
                            <input type="text" className="form-control" id="servico" placeholder="Digite o nome do serviço" value={nome} onChange={e => setNome(e.target.value)} required />
                        </div>
                        <div className="col-md-6">
